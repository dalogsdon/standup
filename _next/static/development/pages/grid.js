(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["static/development/pages/grid.js"],{
...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fgrid&absolutePagePath=%2FUsers%2Fdlogsdon%2FGitHub%2Fstandup%2Fpages%2Fgrid.js!./":
/*!*************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fgrid&absolutePagePath=%2FUsers%2Fdlogsdon%2FGitHub%2Fstandup%2Fpages%2Fgrid.js ***!
  \*************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
    ...
    (window.__NEXT_P=window.__NEXT_P||[]).push(["/grid", function() {
      var page = __webpack_require__(/*! ./pages/grid.js */ "./pages/grid.js")
      if(true) {
        module.hot.accept(/*! ./pages/grid.js */ "./pages/grid.js", function() {
          if(!next.router.components["/grid"]) return
          var updatedPage = __webpack_require__(/*! ./pages/grid.js */ "./pages/grid.js")
          next.router.update("/grid", updatedPage.default || updatedPage)
        })
      }
...
function (_React$Component) {
  ...
  function Grid() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "nameIdsInProgress", new _babel_runtime_corejs2_core_js_set__WEBPACK_IMPORTED_MODULE_6___default.a());
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "announceWinner", function () {
      var prefix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

      var nameIds = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default()(_this.state.winner).sort();

      var winnerNamesText = nameIds.map(function (nameId) {
        return _this.state.winner[nameId].spoken || _this.state.winner[nameId].value;
      }).join(' and ');
      _util_Utils__WEBPACK_IMPORTED_MODULE_15__["default"].say(prefix + winnerNamesText + ' are the winners!');
    });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "declareWinner", function (nameId, isEngineer) {
      _this.incrementToFilteredWinner(nameId, isEngineer).then(function () {
        _this.nameIdsInProgress.delete(nameId);

        var winner = _this.state.names[_this.state.highlight[nameId]];

        _this.setState(function (state) {
          return {
            winner: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_4__["default"])({}, state.winner, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])({}, nameId, winner))
          };
        }, function () {
          if (_this.nameIdsInProgress.size === 0) {
      ...
      return function () {
        if (_this.state.winner[nameId]) {
          _this.setState(function (state) {
            return {
              winner: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_4__["default"])({}, state.winner, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])({}, nameId, winner)),
              highlight: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_4__["default"])({}, state.highlight, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])({}, nameId, highlight))
            };
          }, function () {
            return _this.announceWinner('Just kidding, ');
          });
        }
      };
    });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "incrementToFilteredWinner", function (nameId, isEngineer) {
      if (isEngineer !== undefined) {
        return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_3___default.a(function (resolve) {
          _this._incrementToFilteredWinnerRecur(nameId, isEngineer, resolve);
        });
      }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "_incrementToFilteredWinnerRecur", function (nameId, isEngineer, resolve) {
      var potentialWinner = _this.state.names[_this.state.highlight[nameId]];
      ...
      if (potentialWinner.isEngineer == isEngineer) {
        ...
        window.setTimeout(function () {
          _this.setState(function (state) {
            return {
              highlight: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_4__["default"])({}, state.highlight, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])({}, nameId, (state.highlight[nameId] + 1) % state.names.length))
            };
          }, function () {
            return _this._incrementToFilteredWinnerRecur(nameId, isEngineer, resolve);
          });
        }, 250);
      }
    });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "pickName", function (timeout, isEngineer) {
      ...
      _this.nameIdsInProgress.add(nameId);

      _this.setState(function (state) {
        return {
          highlight: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_4__["default"])({}, state.highlight, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])({}, nameId, 0))
        };
      }, function () {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "_pickNameRecur", function (timeout, isEngineer, nameId) {
      if (timeout > 400) {
        ...
        window.setTimeout(function () {
          ...
          _this.setState({
            highlight: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_4__["default"])({}, _this.state.highlight, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])({}, nameId, randomDir))
          }, function () {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "getNameAttrs", function (name, idx) {
      ...
      for (var _i2 = 0, _Object$entries2 = _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_2___default()(_this.state.winner); _i2 < _Object$entries2.length; _i2++) {
        var _Object$entries2$_i = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_Object$entries2[_i2], 2),
            nameId = _Object$entries2$_i[0],
            winner = _Object$entries2$_i[1];

        if (name.value === winner.value) {
          attrs["data-winner-".concat(nameId)] = true;
        }
      }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(Grid, [{
    ...
    value: function componentDidMount() {
      ...
      var engineerFirst = !!Math.floor(Math.random() * 2);
    ...
    value: function render() {
      ...
      var numWinners = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default()(winner).length;
...
module.exports = __webpack_require__(/*! next-client-pages-loader?page=%2Fgrid&absolutePagePath=%2FUsers%2Fdlogsdon%2FGitHub%2Fstandup%2Fpages%2Fgrid.js! */"./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fgrid&absolutePagePath=%2FUsers%2Fdlogsdon%2FGitHub%2Fstandup%2Fpages%2Fgrid.js!./");
