...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Grid, [{
    ...
    value: function render() {
      var colCount = Math.ceil(Math.sqrt(this.state.names.length));
      var rowCount = Math.ceil(this.state.names.length / rowCount);
      var style = {
        width: 100 / colCount + '%',
        height: 100 / rowCount + '%'
      };
      var names = this.state.names.map(function (n) {
        return n.value;
      });
...
//# sourceMappingURL=grid.js.bf25c39e5d7493d323b7.hot-update.js.map