...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Grid, [{
    ...
    value: function render() {
      ...
      var colCount = Math.ceil(Math.sqrt(names.length));
      var rowCount = Math.ceil(names.length / rowCount);
      var style = {
        width: 100 / colCount + '%',
        height: 100 / rowCount + '%'
      };
...
//# sourceMappingURL=grid.js.85bd027feddb40a1f9f5.hot-update.js.map